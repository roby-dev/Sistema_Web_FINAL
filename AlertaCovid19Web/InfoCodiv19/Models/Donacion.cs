...
namespace InfoCodiv19.Models
{
    public class Donacion
    {
        ...
        public async Task<bool> Set_Donacion(Donacion o)
        {
            try
            {
                var firebase = new Firebase.Database.FirebaseClient("https://proyecto1-a1300.firebaseio.com/");

                var key_dona = Firebase.Database.FirebaseKeyGenerator.Next();               
                await firebase
                  .Child("Donaciones").Child(key_dona)
                  .PutAsync(new Donacion() { tipoDonacion=o.tipoDonacion,
                      noombre_producto=o.noombre_producto,cantidad=o.cantidad,
                      direccion=o.direccion,nombreDonante=o.nombreDonante,
                      latitud=o.latitud,longitud=o.longitud,
                      key_donacion=key_dona,
                      estado_recepcion=o.estado_recepcion,celular=o.celular});
            }
            catch (Exception ex)
            {
